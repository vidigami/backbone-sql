...
(function() {
  var Backbone, BackboneORM, Connection, DESTROY_BATCH_LIMIT, DatabaseTools, DatabaseURL, ModelCache, Queue, Schema, SqlCursor, SqlSync, Utils, crypto, generateModelID, util, _,
  ...
  Queue = BackboneORM.Queue, Schema = BackboneORM.Schema, Utils = BackboneORM.Utils, DatabaseURL = BackboneORM.DatabaseURL;

  ModelCache = BackboneORM.CacheSingletons.ModelCache;

  generateModelID = function(model_type) {
    var name_url, url;
    try {
  ...
  SqlSync = (function() {
    function SqlSync(model_type, options) {
      ...
      this.model_type.model_id = generateModelID(this.model_type);
    ...
    SqlSync.prototype.connect = function(url) {
      var slave_url, _i, _len, _ref, _ref1;
