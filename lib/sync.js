...
(function() {
  var Backbone, BackboneORM, CAPABILITIES, Connection, DESTROY_BATCH_LIMIT, DatabaseTools, DatabaseURL, Queue, Schema, SqlCursor, SqlSync, Utils, crypto, util, _,
  ...
  SqlSync = (function() {
    ...
    SqlSync.prototype.capabilities = function() {
      return CAPABILITIES;
    };
