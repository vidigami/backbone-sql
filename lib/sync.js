...
(function() {
  var Backbone, BackboneORM, Connection, DESTROY_BATCH_LIMIT, DatabaseTools, DatabaseURL, ModelCache, Queue, Schema, SqlCursor, SqlSync, Utils, inflection, util, _,
  ...
  SqlSync = (function() {
    function SqlSync(model_type, options) {
      ...
      this.model_type.model_id = Utils.guid();
