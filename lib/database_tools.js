...
(function() {
  var DatabaseTools, Knex, Queue, _,
  ...
  module.exports = DatabaseTools = (function() {
    function DatabaseTools(connection, table_name, schema) {
    ...
    DatabaseTools.prototype.resetSchema = function(options, callback) {
      ...
      return this.connection.knex().schema.dropTableIfExists(this.table_name).exec(function(err) {
        ...
        _this.addColumn('id', 'increments', ['primary']);
    ...
    DatabaseTools.prototype.ensureSchema = function(options, callback) {
      ...
      return this.hasTable(function(err, has_table) {
    ...
    DatabaseTools.prototype.ensureRelation = function(key, relation, callback) {
      var _this = this;
      if (relation.type === 'belongsTo') {
        return this.hasColumn(relation.foreign_key, function(err, has_column) {
          if (err) {
            return callback(err);
          }
          if (!has_column) {
    ...
    DatabaseTools.prototype.ensureField = function(key, field, callback) {
      var _this = this;
      return this.hasColumn(key, function(err, has_column) {
        if (err) {
          return callback(err);
        }
        if (!has_column) {
