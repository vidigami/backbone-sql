...
(function() {
  ...
  module.exports = DatabaseTools = (function() {
    ...
    DatabaseTools.prototype.createTable = function(callback) {
      ...
      this.connection.knex().schema.createTable(this.table_name, (function(_this) {
        return function(table) {
          return _this.addColumn('id', 'increments', {
            primary: true,
            indexed: true
          }, table);
        };
    ...
    DatabaseTools.prototype.addColumn = function(key, type, options, table_or_callback) {
      var addField;
      if (options == null) {
        options = {};
      }
      ...
      if (_.isFunction(table_or_callback)) {
        this.connection.knex().schema.table(this.table_name, addField).exec(table_or_callback);
      } else {
