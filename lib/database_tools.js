...
(function() {
  var DatabaseTools, KNEX_COLUMN_OPTIONS, KNEX_SKIP, KNEX_TYPES, Knex, Queue, knex_helpers, _, _deprecate,
  ...
  module.exports = DatabaseTools = (function() {
    ...
    DatabaseTools.prototype.createOrUpdateTable = function(options, callback) {
      this.hasTable((function(_this) {
        return function(err, table_exists) {
          var columns, field, group, key, override, relation, type, _i, _len, _ref, _ref1;
          if (err) {
            return callback(err);
          }
          if (options.verbose) {
          ...
          return group(columns, function(err, result) {
            ...
            return _this.connection.knex().schema[table_exists ? 'table' : 'createTable'](_this.table_name, function(table) {
              var column_info, _j, _k, _len1, _len2, _ref2, _ref3, _results;
              _ref2 = result.add;
              for (_j = 0, _len1 = _ref2.length; _j < _len1; _j++) {
                column_info = _ref2[_j];
                _this.addColumn(table, column_info);
              }
              _ref3 = result.update;
              _results = [];
              for (_k = 0, _len2 = _ref3.length; _k < _len2; _k++) {
                column_info = _ref3[_k];
    ...
    DatabaseTools.prototype.addColumn = function(table, column_info) {
      var column, column_args, constructor_options, _ref;
