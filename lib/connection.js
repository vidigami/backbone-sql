...
(function() {
  var BackboneORM, Connection, ConnectionPool, DatabaseURL, Knex, KnexConnection, PROTOCOLS, Queue, _;
  ...
  Queue = BackboneORM.Queue, DatabaseURL = BackboneORM.DatabaseURL, ConnectionPool = BackboneORM.ConnectionPool;
